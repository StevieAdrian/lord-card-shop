<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Website.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="lord_card_shop.Views.User.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="hero w-100 text-center px-3" style="min-height: 85vh;">
        ...
        <h1 class="py-2">Hello <asp:Label ID="username" runat="server" />, Welcome to Lord Card Shop!</h1>
